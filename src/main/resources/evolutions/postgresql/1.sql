...
CREATE TABLE journal_201505 (
    PRIMARY KEY(id),
    check (created_at BETWEEN '201-05-01' AND '2015-05-31')
) INHERITS (journal);
...
DROP TABLE IF EXISTS journal_201508 CASCADE;
DROP TABLE IF EXISTS journal_201509 CASCADE;
DROP TABLE IF EXISTS journal_201510 CASCADE;
DROP TABLE IF EXISTS journal_201511 CASCADE;
DROP TABLE IF EXISTS journal_201512 CASCADE;
