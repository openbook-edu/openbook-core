...
object TestValues {
  ...
  val testVideoComponentB = VideoComponent(
    ...
    data = MediaData(Some("vimeo"), Some("19579282")),
    width = 640,
    height = 480,
    order = 3,
    createdAt = new DateTime(2014, 8, 3, 14, 1, 19, 545, DateTimeZone.forID("-04")),
  ...
  val testVideoComponentL = VideoComponent(
    ...
    data = MediaData(Some("s3"), Some("some_video.mp4"), Some("video/mp4"), Some(4123456)),
    width = 640,
    height = 480,
    order = 3,
    createdAt = new DateTime(2014, 8, 3, 14, 1, 19, 545, DateTimeZone.forID("-04")),
  ...
  val testVideoComponentF = VideoComponent(
    ...
    data = MediaData(Some("vimeo"), Some("19579283")),
    width = 640,
    height = 480,
    order = 0,
    createdAt = new DateTime(2014, 8, 5, 14, 1, 19, 545, DateTimeZone.forID("-04")),
  ...
  val testAudioComponentC = AudioComponent(
    ...
    data = MediaData(Some("sound_cloud"), Some("dj-whisky-ft-nozipho-just")),
    order = 0,
    createdAt = new DateTime(2014, 8, 5, 14, 1, 19, 545, DateTimeZone.forID("-04")),
    updatedAt = new DateTime(2014, 8, 6, 14, 1, 19, 545, DateTimeZone.forID("-04"))
  )
  ...
  val testAudioComponentM = AudioComponent(
    ...
    data = MediaData(Some("s3"), Some("some_audio.mp3"), Some("audio/mp3"), Some(2236480)),
    order = 0,
    createdAt = new DateTime(2014, 8, 5, 14, 1, 19, 545, DateTimeZone.forID("-04")),
    updatedAt = new DateTime(2014, 8, 6, 14, 1, 19, 545, DateTimeZone.forID("-04"))
  )
  ...
  val testAudioComponentD = AudioComponent(
    ...
    data = MediaData(Some("sound_cloud"), Some("fetty-wap-my-way-feat-monty")),
    order = 0,
    createdAt = new DateTime(2014, 8, 9, 14, 1, 19, 545, DateTimeZone.forID("-04")),
    updatedAt = new DateTime(2014, 8, 10, 14, 1, 19, 545, DateTimeZone.forID("-04"))
  )
  ...
  val testAudioComponentE = AudioComponent(
    ...
    data = MediaData(Some("sound_cloud"), Some("revolution-radio-network")),
    order = 0,
    createdAt = new DateTime(2014, 8, 7, 14, 1, 19, 545, DateTimeZone.forID("-04")),
    updatedAt = new DateTime(2014, 8, 8, 14, 1, 19, 545, DateTimeZone.forID("-04"))
  )
  ...
  val testBookComponentO = BookComponent(
    ...
    data = MediaData(data = Some("some text from a book"), dataType = Some("epub"), size = Some(4)),
    order = 0,
    createdAt = new DateTime(2014, 8, 7, 14, 1, 19, 545, DateTimeZone.forID("-04")),
    updatedAt = new DateTime(2014, 8, 8, 14, 1, 19, 545, DateTimeZone.forID("-04"))
  )
